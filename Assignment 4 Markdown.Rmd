...
lobster_table <- kable(lobster_count, align = "c",col.names = c("Site", "2012", "2013", "2014", "2015", "2016", "2017")) %>% 
   kable_styling(bootstrap_options = "striped", full_width = F) #create summary table
...
trap_table <- kable(trap_count, align = "c",col.names = c("Site", "2012", "2013", "2014", "2015", "2016", "2017")) %>% 
...
lobster_line <- ggplot (lobster_count, aes( x= YEAR)) +
  geom_line(fill = SITE)+
  scale_x_discrete(limits = c(2012, 2013, 2014, 2015, 2016, 2017)) +
